...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  void _confirmOrder(MainProvider mainProvider, Cart selectedCart) async {
    await showAlert(
      context: context,
      title: 'Alert',
      onPressed: () {
        Navigation.back();
        String result = mainProvider.checkoutItem(widget.selectedCart);
        if (result == 'OK') {
      ...
      content: 'Apakah anda yakin untuk order?',
    );
  }
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        if (_name != '' && _address != '' && _phoneNumber != '') {
                          _confirmOrder(data, widget.selectedCart);
                        } else {
                          Fluttertoast.showToast(
                              msg: 'Silahkan isi data pembeli terlebih dahulu',
